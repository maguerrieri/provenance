...
def test_both_paths_write_the_phrase_the_skill_matches(root):
    """The research skill does not retry an unsettled figure, told by `verify.UNSETTLED` in
    its reason, and this phrase says which unsettled record it is. `provenance verify` and `provenance build` word the rest of their reasons differently."""
